...
const text = [
  ...
  form.addEventListener('submit', (e) => {
      // we did it because it is a default behavior for the form submitting to the server.      
      e.preventDefault();
      //amount.value is string although type in the input is number
      //thats why we used parseInt
